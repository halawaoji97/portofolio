...
const Footer = () => {
  return (
    <footer className='mt-12 relative left-0 bottom-0 right-0 bg-gradient-to-b from-dark-secondary to-dark-bg  rounded-t-2xl rounded-r-2xl'>
      ...
      <div className='flex justify-around w-64 md:w-96 mx-auto items-center py-6'>
        <span className='text-cyan-light rounded-full bg-dark-bg flex justify-center items-center border-2 h-10 w-10 border-cyan-light  mr-4'>
          <FaLinkedin size={24} />
        </span>
        <span className='text-cyan-light rounded-full bg-dark-bg flex justify-center items-center border-2 h-10 w-10 border-cyan-light  mr-4'>
          <FaInstagram size={24} />
