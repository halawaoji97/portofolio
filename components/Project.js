...
const Project = () => {
  return (
    <section className='md:h-screen justify-center items-center flex'>
      <div className='container mx-auto px-6 md:px-0'>
        ...
        <div className='grid my-12 grid-cols-1 grid-rows-3 md:grid-rows-1 gap-4 md:gap-6 md:grid-cols-3 lg:grid-cols-3 justify-center'>
          <div className='shadow-lg bg-gradient-to-r  from-dark-bg to-cyan-700 rounded-2xl relative'>
          ...
          <div className='bg-grey-primary rounded-2xl relative'>
            <div className='rounded-2xl relative'>
              <Image
                src={Project2}
                alt='Project 2 | Garos'
